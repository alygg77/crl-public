class Select {
    ...
    static template(params) {
        ...
        let selectedIndex = -1;
        let selectedValue = '';
        let selectedContent = 'Choose from the list';
      ...
      <div class="itc-select__dropdown">
        <ul class="itc-select__options">${items.join('')}</ul>
      </div>`;
    }
    ...
    _reset() {
        ...
        this._elToggle.textContent = 'Choose from the list';
